 ...
 * Constructor.
 */
CGXDLMSImageActivateInfo::CGXDLMSImageActivateInfo(long size, std::string identification, std::string signature)
{
    m_Size = size;
...
*/
std::string CGXDLMSImageActivateInfo::GetIdentification()
{
    return m_Identification;
}
void CGXDLMSImageActivateInfo::SetIdentification(std::string value)
{
...
*/
std::string CGXDLMSImageActivateInfo::GetSignature()
{
    return m_Signature;
}
void CGXDLMSImageActivateInfo::SetSignature(std::string value)
{
    m_Signature = value;
}
